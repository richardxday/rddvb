...
void ADVBProgList::AddXMLTVChannel(const AStructuredNode& channel)
{
	static const REPLACEMENT replacements[] = {
		...
		{"BBC Three", "BBC3"},
		{"BBC Four", "BBC4"},
		{"BBC Radio 4 FM", "BBC Radio 4"},
		{"BBC Radio 6", "BBC 6 Music"},
		{"CBBC Channel", "CBBC"},
		{"Challenge TV", "Challenge"},
		...
		{"5 Star", "5STAR"},
		{"ITV1", "ITV"},
		{"Smooth FM 102.2", "Smooth Radio"},
		{"True Ent", "True Entertainment"},
		{"Yesterday UKTV", "Yesterday"},
		{"Your TV", "YourTV"},
		{"Heart FM", "Heart"},
		{"Food Network FM", "Food Network"},
		{"Rocks and Co 1", "Rocks & Co 1"},
	};
	const ADVBConfig& config = ADVBConfig::Get();
